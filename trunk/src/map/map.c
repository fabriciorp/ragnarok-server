 ...
 * @author eADev Team 
 * 
 * @desc Faz a convers„o do tipo de gat para informaÁıes 
 * do tipo cell 
 * @param int gat Tipo do gat 
 * @return struct mapcell com as informaÁıes adequadas 
 * Otimizado [Keoy] 
 */ 
inline static struct mapcell map_gat2cell(int gat)
{
	...
	// Tipos de GAT 
	// 0: Ch„o and·vel e atir·vel 
	// 1: Ch„o n„o-and·vel e n„o-atir·vel 
	// 2: Ch„o and·vel e atir·vel (???) 
	// 3: ¡gua and·vel e atir·vel 
	// 4: Ch„o and·vel e atir·vel (???) 
	// 5: Ch„o n„o-and·vel e atir·vel 
	// 6: Ch„o and·vel e atir·vel (???) 
	if ((gat < 0) || (gat > 6)) 
